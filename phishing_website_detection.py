...
def load_data(dataset):
  ...
  if dataset=="phishing_website_detection":
    file="static\phishing_website_detection.csv"
...
def data_visualisation(data):
    ...
    sns.scatterplot(x='Result',y='Page_Rank',data=data)
...
def model(algorithm,X_train, X_test, y_train, y_test,epochs=100):
    ...
    if algorithm== "DecisionTreeClassifier":
        ...
        pickle.dump(model1, open("static/phishing_website_detection.pkl","wb"))
