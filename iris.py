...
def data_visualisation(data):
    ...
    '''''
    a,=sns.scatterplot(x='Species',y='SepalLengthCm',data=data)
    b,=sns.scatterplot(x='Species',y='PetalLengthCm',data=data)
    c,=sns.scatterplot(x='Species',y='SepalWidthCm',data=data)
    '''
...
def model(algorithm,X_train, X_test, y_train, y_test,epochs=100):
    if algorithm== "DecisionTreeClassifier":
        ...
        pickle.dump(model1, open("static/model_iris.pkl","wb"))
